...
| L5    | operators   | `packages/admin-client/**`, `packages/ops-cli/**`, `packages/claude-plugin/**`, `scripts/**`                                                                                                                                                           | client: nothing; cli: client + builtins; plugin: builtins + tooling; scripts: package indexes |
