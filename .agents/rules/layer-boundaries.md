...
| L5    | operators   | Admin API client, CLI, Claude Code plugin, build/deploy/harness scripts          | `packages/admin-client`, `packages/ops-cli`, `packages/claude-plugin`, `scripts` |
