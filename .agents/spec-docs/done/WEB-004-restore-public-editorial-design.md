...
- Action: `node /tmp/verify-publisher-cdp.mjs` drove installed Chrome against `https://www.xrtechnews.com` at 1440×1000 and 390×844 with JavaScript enabled and disabled.
