...
describe('HTML body import contract', () => {
  ...
  it('converts published and third-party X post markup into embed directives', () => {
    const markdown = importHtmlBodyToMarkdown(
      '<p>Intro.</p>' +
        '<figure class="publisher-x-post" data-publisher-x-post="true"><blockquote><p>Demand is "really" unprecedented.</p></blockquote><figcaption><a href="https://x.com/thsottiaux/status/2097559315150426222">Tibo on X</a></figcaption></figure>' +
