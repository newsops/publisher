...
const canonical = 'https://x.com/examplesource/status/1234567890123456789'
const fixture = {
  author_name: 'Example Source',
  author_url: 'https://x.com/examplesource',
  html: '<blockquote class="twitter-tweet"><p lang="en">Demand is unprecedented &amp; existing users come first.</p><a href="https://x.com/examplesource/status/1234567890123456789">September 9, 2026</a></blockquote>',
}
...
describe('X oEmbed editorial contract', () => {
  it('only accepts canonical numeric X status URLs', () => {
    ...
    for (const invalid of [
      'https://twitter.com/examplesource/status/1234567890123456789',
      'https://example.com/examplesource/status/1234567890123456789',
      'https://x.com/examplesource/status/not-a-number',
    ])
